...
def T():
        ...
        yt.streams.filter(resolution="144p").first().download(output_path=download_location, filename=video, filename_prefix="",skip_existing=False, timeout=35, max_retries=10)
